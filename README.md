...
For a complete list of APIs and examples, see the [godoc documentation](https://pkg.go.dev/github.com/denyu95/minio-v7p) or [Go Client API Reference](https://min.io/docs/minio/linux/developers/go/API.html).
...
```sh
go get github.com/denyu95/minio-v7p
```
...
* [Godoc Documentation](https://pkg.go.dev/github.com/denyu95/minio-v7p)
